...
from .models import Contact, Newsletter, Hr
...
class HrForm(forms.ModelForm):
    ...
    contactname = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Your Name Here'}))
    contactemail = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Your Email Here'}))
    jobtype = forms.ChoiceField(choices=JobType, required=False, widget=forms.Select(attrs={'class':'form-control'}), widget=DisableChoice)
    fulltime = forms.ChoiceField(choices=FullTime, required=False, widget=forms.Select(attrs={'class':'form-control'}), widget=DisableChoice)
    internship = forms.ChoiceField(choices=Internship, required=False, widget=forms.Select(attrs={'class':'form-control'}), widget=DisableChoice)
    country = forms.ChoiceField(choices=COUNTRIES, required=False, widget=forms.Select(attrs={'class':'form-control'}), widget=DisableChoice)
    contacttel = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control'}))
